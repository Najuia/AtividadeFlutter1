...
class _AulaComponentesState extends State<AulaComponentes> {
  ...
  final List<Map<String, Object>> perguntas = [
    ...
    {
     "texto" : "Qual seu genero de filme favorito?",
     "respostas" : ["Romance", "Terror", "Ação", "Suspense" ]
    },
   {
    "texto" : "Qual sua  rede social favorita?",
    "respostas" : ["TODAS", "Whatsapp","Instagram", "Tik' tok" ]
   },
...
return perguntaAtual < perguntas.length;  
  ...
  Widget build(BuildContext context){
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: temPergunta ? Questao(perguntas[perguntaAtual]["texto"].toString())
          : Questao("Terminou")
        ),
